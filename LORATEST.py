...
devaddr = bytearray([0x26, 0x02, 0x1B, 0xFF])
#devaddr = bytearray([0x26, 0x02, 0x1A, 0x60])
# TTN Network Key, 16 Bytes, MSB
nwkey = bytearray([0x6F, 0x65, 0x4F, 0x96, 0xC5, 0x90, 0x04, 0x57, 0x69, 0x5E, 0x2D, 0x0F, 0xC6, 0xA3, 0x6C, 0x7B])
...
app = bytearray([0xF2, 0x3F, 0x1B, 0x0E, 0xF9, 0x81, 0x06, 0x73, 0x25, 0x0C, 0xDA, 0x77, 0xF5, 0x8A, 0x56, 0xD8])
